        ...
        <section className="relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
          ...
          <div className="hidden lg:relative lg:block lg:p-12">
            ...
            <p className="mt-4 leading-relaxed text-white/90">
              Donde las calles son tu pista de pruebas. Inicia sesión para comenzar tu viaje hacia la cima y desafiar a los mejores pilotos de la ciudad. ¡Que la velocidad esté de tu lado!
            </p>
          </div>
        </section>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="mt-8 grid grid-cols-6 gap-6">
                ...
                <Controller
                  ...
                  render={({ field: { onChange, value } }) => (
                    <Input
                      ...
                      className="mt-3 w-full rounded-md text-sm shadow-sm border-gray-700 bg-gray-800 text-gray-200"
                      style={{ height: '30px' }}
                    />
                  )}
                />
              ...
              <div className="col-span-6 sm:flex sm:items-center sm:gap-4">
                ...
                <p className="mt-4 text-sm text-gray-500 sm:mt-0 dark:text-gray-400">
                  ...
                  <a href="#" className="text-gray-700 underline dark:text-gray-200">Crea una cuenta</a>.
                </p>
              </div>
            </form>
          </div>
