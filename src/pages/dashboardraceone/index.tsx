...
function DashboardRaceOne(): JSX.Element {
  const [page, setPage] = useState(1);
  const [limit, setLimit] = useState(20);

  const { racesTime, isFetching: isFetchingStats } = getUserTime({ raceNumber: 1, page, limit });
...
export default DashboardRaceOne;